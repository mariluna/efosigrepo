...
function calcularEdad()
{
	...
	<?php
		...
		echo form_open(base_url().'api/personas_api/update',$d);
	?>
...
<div class="col-lg-12" ng-app="persona">
	...
	<div class="col-lg-4" style="text-align:center">
		...
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			...
			2.No <input type="radio" value="No" name="etnia" checked="checked" onclick="ocultar_etnia()">
				<div id="etnia2">
					Nombre de Etnia:<br>
					<input type="text" class="auth-input" onkeypress="return soloLetras(event)" name="cualEtnia" maxLength="25">
					<br><br>
					8.1. ¿Domina Idioma?
					<br><br>
			...
			2.No <input type="radio" value="No" name="etnia" onclick="ocultar_etnia()">
				<div id="etnia2">
					Nombre de Etnia:<br>
					<input type="text" class="auth-input" onkeypress="return soloLetras(event)" name="cualEtnia" maxLength="25" value="<?php echo $persona->etnia; ?>">
					<br>
		...
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			...
			<input id="telHab" class="auth-input" onblur="soloTelefonoHab(this)" onkeypress="return soloNumeros(event)" type="text" value="<?php echo $persona->tel_local; ?>" name="telHab" maxlength="11" required></input>
		</p>
		
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			<label for="telCel">Tel&eacute;fono Celular:</label><br>
			<input id="telCel" class="auth-input" onblur="soloTelefonoCel(this)" onkeypress="return soloNumeros(event)" type="text" value="<?php echo $persona->tel_celular; ?>" name="telCel" maxlength="11" required></input>
		</p>
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
		...
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			...
			<?php }else{ echo "<script> 
				...
				2.No <input type="radio" value="No" name="mision" onclick="ocultar_mision()">
					<div id="misiones2">
						3.1.Cu&aacute;l(es):<br>
						<textarea id="cualMision" class="auth-input auth-textarea" type="text" value="<?php echo $persona->gustaria_estudiar; ?>" name="cualMision"></textarea> 
					</div>
			<?php } ?>		
		</p>
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			...
			<?php if($persona->gustaria_estudiar == "No"){ ?>
				...
				2.No <input type="radio" value="No" name="estudiar" checked="checked" onclick="ocultar_estudiar()">
					<div id="estudiar2">
						...
						<input id="gustEstudiar" class="auth-input" onkeypress="return soloLetras(event)" type="text" value="" name="gustEstudiar" maxlength="25"></input> 
					</div>	
			<?php }else{ echo "<script> 
								$(function(){
									$('#estudiar2').show();
				...
				2.No <input type="radio" value="No" name="estudiar" onclick="ocultar_estudiar()">
					<div id="estudiar2">
						4.1.&iquest;Qu&eacute; le gustar&iacute;a estudiar?<br>
						<input id="gustEstudiar" class="auth-input" onkeypress="return soloLetras(event)" type="text" value="<?php echo $persona->gustaria_estudiar; ?>" name="gustEstudiar" maxlength="25"></input> 
					</div>	
			<?php } ?>
		</p>
	</div>
	<div class="col-lg-4" style="text-align:center">
			...
			<?php }else{ echo "<script> 
				...
				2.No <input type="radio" value="No" name="movimiento"  onclick="ocultar_movimiento()">
					<div id="movimiento2">
						...
						1.3.Responsabilidad: <br>
						<input class="auth-input" type="text" onkeypress="return soloLetras(event)" name="responsabilidadMov" value="<?php echo $persona->responsabilidad;?>" maxLength="25" size="20"> <br>
					</div>	
			<?php } ?>
		</p>
			...
			<?php }else{ echo "<script> 
				...
				1.Si <input type="radio" value="Si" name="partido"  checked="checked" onclick="mostrar_partido()">&nbsp;
					2.No <input type="radio" value="No" name="partido"  onclick="ocultar_partido()">
						<div id="partido2">
						1.1.&iquest;Cu&aacute;l?<br>
						<input id="cualPartido" class="auth-input" onkeypress="return soloLetras(event)" type="text" value="<?php echo $persona->participa_part_politico; ?>" name="cualPartido" maxlength="25"/><br><br>
						1.2.A&ntilde;os de Militancia:<br>
						<input id="militanciaPar" class="auth-input" onkeypress="return soloNumeros(event)" type="text" value="<?php echo $persona->anios_militancia_pp;?>" name="militanciaPar" maxlength="2" integer/><br><br>
						1.3.Responsabilidad: <br>
						<input id="responsabilidadPar" class="auth-input" onkeypress="return soloLetras(event)" type="text" value="<?php echo $persona->responsabilidad_pp;?>" name="responsabilidadPar" maxlength="25">
					</div>
			...
			<?php }else{ ?>
				...
				2.No<input type="radio" value="No" name="concejoC" onclick="ocultar_concejoC()">
					<div id="concejoC2">
						...
						<div id="voceria2">
							&iquest;Cu&aacute;l?:<br>
							<input id="cualVoceria" onkeypress="return soloLetras(event)" class="auth-input" type="text" value="<?php echo $persona->comuna_cc; ?>" name="cualVoceria" maxlength="25"/>
						</div><br>
						<?php } ?>
					</div>
			<?php } ?>
		...
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			<label for="instTrabajo">Instituci&oacute;n donde labora: </label><br>
			<input id="instTrabajo" class="auth-input"  onkeypress="return soloLetrasYNumeros(event)" type="text" value="<?php echo $persona->institucion_labora; ?>" name="instTrabajo" maxlength="50"/>
		</p>
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			<label for="cargo">Cargo o rol que ejerce:</label><br>
			<input id="cargo" class="auth-input" type="text" onkeypress="return soloLetras(event)" value="<?php echo $persona->cargotrab; ?>" name="cargo" maxlength="50"></input> 
		</p>
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			<label for="telOficina">Tel&eacute;fono (oficina):</label><br>
			<input id="telOficina" class="auth-input" type="text" onblur="soloTelefonoHab(this)" onkeypress="return soloNumeros(event)" value="<?php echo $persona->teltrab; ?>" name="telOficina" maxlength="11" integer></input>
		</p>
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			<label for="correoTrabajo">Correo Electr&oacute;nico:</label><br>
			<input id="correoTrabajo" class="auth-input" type="text" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"  value="<?php echo $persona->emailtrab; ?>" name="correoTrabajo" maxlength="50"></input>
		</p>
	</div>
<?php echo form_close(); ?>
</div>