...
<br>
	...
	<div class="col-lg-4" style="text-align:center">
		...
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			...
			<input Class="auth-input dis" type="text" value="<?php echo $persona->institucion_labora; ?>" readonly></input>
		</p>
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			<label for="cargo">Cargo o rol que ejerce:</label><br>
			<input Class="auth-input dis" type="text" value="<?php echo $persona->cargotrab; ?>" readonly></input>
		</p>
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			<label for="telOficina">Tel&eacute;fono (oficina):</label><br>
			<input Class="auth-input dis" type="text" value="<?php echo $persona->teltrab; ?>" readonly></input>
		</p>
		<p style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: 700;">
			<label for="correoTrabajo">Correo Electr&oacute;nico:</label><br>
			<input Class="auth-input dis" type="text" value="<?php echo $persona->emailtrab; ?>" readonly></input>
		</p>
	</div>
</div>