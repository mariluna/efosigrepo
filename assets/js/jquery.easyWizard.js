    ...
    var easyWizardMethods = {
        init : function(options) {
            var settings = $.extend( {
                ...
                'stepsText' : '{n}. {t}',
                'showButtons' : true,
                'buttonsClass' : 'auth-button btn-danger',
                'prevButton' : '<< Atras',
                'nextButton' : 'Siguiente >>',
                'debug' : false,
                'submitButton': true,
                'submitButtonText': 'Guardar',
                'submitButtonClass': 'auth-button btn-danger',
            ...
            return this.each(function() {
                ...
                if(thisSettings.steps > 1) {
                    ...
                    $steps.each(function(index) {
                        ...
                        if(!index) {
                            $(this).addClass('active').css('min-height', '300px');
			    $(this).addClass('active').css('height', 'auto');
                    ...
                    if(thisSettings.showButtons) {
                        paginationHtml = '<div class="easyWizardButtons">';
                            ...
                            paginationHtml += thisSettings.submitButton?'<button name="guardarpago" type="submit" class="submit '+thisSettings.submitButtonClass+'">'+thisSettings.submitButtonText+'</button>':'';
                        paginationHtml  += '</div>';
